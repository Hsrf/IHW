...
enum logic [6:0] {
	...
	Increment = 7'd26,
	IncrementOp = 7'd27,
	IncrementRegWrite = 7'd28,
	Decrement = 7'd29,
	DecrementOp = 7'd30,
	DecrementRegWrite = 7'd31
} state, nextstate;
...
always @* begin
	case(state)
		...
		IncrementOp:begin
				...
				MuxStore = 1'd0;
				SControl 2'd0;
				nextstate = IncrementRegWrite;
		end
		
		IncrementRegWrite:begin
				ALUSrcA = 2'd0;
				ALUSrcB = 3'd0;
				PCSource = 3'd5;
				ALUOp = 3'd0;
